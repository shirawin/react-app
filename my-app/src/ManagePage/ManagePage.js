...
const ManagePage = () => {
  ...
  const data = [{ "dest": "dfghjkl", "from": "jjjני ברק", "ls": [1, 2, 3] }, { "dest": "jhgf", "from": "בני ברק", "ls": [1, 2, 3] }, { "dest": "ירושלים", "from": "בני ברק", "ls": [1, 2, 3] }, { "dest": "ירושלים", "from": "בני ברק", "ls": [1, 2, 3] }, { "dest": "בני ברק", "from": "פתח תקווה", "ls": [81, 28, 39] }, { "dest": "כינר", "from": "בני ברק", "ls": [14, 42, 43] }];
    ...
    <div id="main">
      ...
      <FormControl id="form" className='header'> <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center' }}>
        ...
        <Grid item xs
          ...
          <Grid item style={{ width: '14vw',backgroundColor:'pink' }}>
